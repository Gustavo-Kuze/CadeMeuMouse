...
namespace ShakeAndFind.Behavior
{
    public class Controller
    {
        ...
        public Controller(/*Form ParentForm*/)
        {
            //Parent = ParentForm;
        }

        public static void hidePointerForm()
        {
            try
            {
        ...
        public static void showPointerForm()
        {
            try
            {
                Helper.getCursorInstance().Invoke(new MethodInvoker(() =>
        ...
        public static void animatePointer(PictureBox picMouse)
        {
...
//public static bool isShowTime2()
//{
