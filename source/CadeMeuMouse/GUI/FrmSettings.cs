...
/*Já fiz os settings pra receber a opção de iniciar no arranque do sistema
 
     agora eu tenho que setar na FrmEntryPoint pra ele adicionar ou remover o programa
     da pasta de inicialização de acordo com os settings
     
     talvez eu também devesse planejas melhor como as configurações são lidas, por exemplo, 
     se não existir uma configuração salva no json, ao invés de dar um erro cabuloso, eu uso o valor padrão*/
...
namespace CadeMeuMouse.GUI
{
    public partial class FrmSettings : Form
    {
        ...
        private void loadSettings()
        {
            ...
            chkOpenAtStartup.Checked = model.OpenAtStartup;
        }
        ...
        private void chkOpenAtStartup_Click(object sender, EventArgs e)
        {
            App.Utils.startProgramWithWindows(((CheckBox)sender).Checked);
        }
    }
}
